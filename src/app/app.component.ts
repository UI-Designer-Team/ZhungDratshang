...
import { studentDetails } from './model.ts/model';
...
ExportTOExcel()
{
  ...
  constructor( public print: NgxPrintElementService, private APISERVICE:APIService,  private service:ServiceService, public dialog: MatDialog){
...
openDialog2() {
  ...
  dialogRef.afterClosed().subscribe(result => {
    ...
    valueChange:string;
    changeContent(){
      this.service.contentSubject.subscribe((data)=> {
