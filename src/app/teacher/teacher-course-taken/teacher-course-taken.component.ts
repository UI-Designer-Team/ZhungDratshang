...
import { TeacherCourseTakenFormComponent } from './teacher-course-taken-form/teacher-course-taken-form.component';
...
@Component({
  selector: 'app-teacher-course-taken',
  templateUrl: './teacher-course-taken.component.html',
  styleUrls: ['./teacher-course-taken.component.css']
})
export class TeacherCourseTakenComponent implements OnInit {
  searchValue:any;
